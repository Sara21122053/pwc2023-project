...
class Program
{
    ...
    {
        Conference conference = new Conference("Conference Event", "Conference against discrimination in the labor and legal field", DateTime.Now, TimeSpan.FromHours(2), "456 Elm St", "Marco Harris", 100);
        Reception reception = new Reception("Reception Event", "Reception to celebrate the baptism of a 15-year-old girl", DateTime.Now, TimeSpan.FromHours(3), "789 Oak St", "gilguero@gmail.com");
        OutdoorMeeting outdoorMeeting = new OutdoorMeeting("Outdoor Meeting Event", "A 7-year-old's birthday will be celebrated outdoors along with a painting war", DateTime.Now, TimeSpan.FromHours(4), "321 Maple St", "Sunny");
